...
class DepartmentRepositoryTest {
    ...
    void changeTest () {
        ...
        /*
            ...
            해결방안 - 데이터 수정시 반대편 엔터티에도 같이 수정을 해줘야 함
         */
...
//        // 핵심 코드
//        department.getEmployees().add(employee); // 반대편 엔터티 같이 수정하기
...
//        employee.setDepartment(null); // 커미션 끊기 - 자식도 부모를 버려야함
    ...
    @Test
    @DisplayName("양방향관계에서 리스트에 데이터를 추가하면 DB에도 INSERT 된다")
